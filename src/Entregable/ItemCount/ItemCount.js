...
export const ItemCount = ({onAdd, stock, init}) => {
    ...
    <div id="itemCount">
        <div id="contador" style={{display:'flex', flexDirection:'row', justifyContent:'space-evenly', margin:'10px'}}>
            ...
            <p>{count}</p>
            <button onClick={handleRemove} type="button" className="btn btn-primary"> - </button>
        </div>
        <div>
            <button onClick={handleOnAdd} type="button" className="btn btn-primary">Agregar al carrito</button>
        </div>
